package com.hisham.githubviewer.core.ui
...
import com.hisham.githubviewer.app.ui.theme.PrimaryBlue

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun GithubAppScaffold(screenNavParams: ScreenNavParams, screen: @Composable (PaddingValues) -> Unit) {
    Scaffold(
        modifier = Modifier
            .fillMaxSize()
